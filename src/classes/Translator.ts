...
export class Translator extends null {
	 ...
	 * 選項形別－中文名稱對照表
	 */
	static readonly ApplicationCommandOptionTypeChinese: {
		[key in ApplicationCommandOptionType]: string;
	} = Object.freeze({
	 ...
	 * 擴展的選項型別－中文名稱對照表
	 */
	static readonly CommandOptionTypeChinese: {
		[key in CommandOptionType]: string;
	} = Object.freeze({
